...
- Read the Antigravity instruction chain applicable to every changed path: `GEMINI.md`, `AGENTS.md`, and rules under `.agents/rules/*.md` in each directory from the repository root toward that path.
